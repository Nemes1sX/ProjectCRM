        ...
        <div class="col-lg-9 mt-4">
            <div class="row">
                <div class="card bg-secondary text-white col-md-3">
                    <div class="card-body">{{$t('backlog_tasks')}}: {{tasksToDo}}</div>
                </div>
                <div class="card bg-danger text-white col-md-3">
                    <div class="card-body">{{$t('to_do_tasks')}}: {{tasksToDo}}</div>
                </div>
                <div class="card bg-primary text-white col-md-3">
                    <div class="card-body">{{$t('in_progress_tasks')}}: {{tasksInProgress}}</div>
                </div>
                <div class="card bg-success text-white col-md-3">
                    <div class="card-body">{{$t('completed_tasks')}}: {{tasksCompleted}}</div>
                </div>
            </div>
        </div>
        <div class="taskbar">
